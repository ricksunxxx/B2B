 ...
 */
function QRCodeAlgs(data, errorCorrectLevel) {
...
QRCodeAlgs.prototype = {
    constructor: QRCodeAlgs,
    /**
    * 获取二维码矩阵大小
    * @return {num} 矩阵大小
    */
    ...
    */
    createData: function createData() {
        ...
        while (true) {
            ...
            buffer.put(QRCodeAlgs.PAD0, 8);

            if (buffer.length >= this.totalDataCount * 8) {
                break;
            }
            buffer.put(QRCodeAlgs.PAD1, 8);
        }
 ...
 * 填充字段
 */
QRCodeAlgs.PAD0 = 0xEC;
QRCodeAlgs.PAD1 = 0x11;
 ...
 * @return {[type]} [description]
 */
QRCodeAlgs.prototype.getRightType = function () {
